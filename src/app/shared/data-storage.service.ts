...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    //   // headers: headers
    // });
    const req = new HttpRequest('PUT', 'https://ng-recipe-book-2-783c4.firebaseio.com/recipes.json',
  ...
  getRecipes() {
    ...
    this.httpClient.get<Recipe[]>('https://ng-recipe-book-2-783c4.firebaseio.com/recipes.json', {
      observe: 'body',
      responseType: 'json'
    })
      .map(
